    ...
    <section className="w-full min-h-screen flex flex-col items-center bg-white py-12">
      <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto gap-8 items-center">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-start">
          ...
          <p className="font-montserrat text-base md:text-[14px] text-[#444] mb-6">
            ...
            transporte de hidrocarburos. También ha participado en proyectos
            relacionados con la importación de productos petrolíferos y GNL, así
            como en el desarrollo de plantas industriales y proyectos de ductos.
          </p>
        </div>
      </div>
      <div className="w-full max-w-6xl mx-auto mt-8">
        <p className="font-montserrat text-sm md:text-[14px] text-[#444] text-justify">
          ...
          estaciones de bombeo y muelles. Esto se ha logrado gracias a la amplia
          experiencia y conocimiento de Grupo Marsori, ya que la mayoría de su
          personal son jubilados de Pemex, y al profesionalismo de jóvenes
      ...
      <div className="w-full max-w-4xl mx-auto mt-16 mb-12 flex flex-col gap-12">
        <div>
          ...
          <p className="font-montserrat text-[14px] text-[#444]">
            ...
            natural, gas LP y derivados del petróleo, así como la gestión de las
            importaciones de hidrocarburos. Mejoramos continuamente nuestra
            calidad, puntualidad y rentabilidad, satisfaciendo las necesidades
            de nuestros clientes dentro del marco regulatorio de seguridad,
            salud ocupacional y protección ambiental, mediante el compromiso de
            quienes trabajamos en esta empresa de ser eficientes, eficaces y
            confiables, para ser una organización rentable y productiva.
          </p>
        </div>
        <div>
          <h3 className="font-montserrat font-bold text-3xl md:text-4xl text-[#181818] mb-4">
          ...
          <p className="font-montserrat text-[14px] text-[#444]">
            ...
            calidad, la seguridad y salud ocupacional y la protección del medio
            ambiente. Buscamos alcanzar y aumentar nuestra capacidad,
            manteniendo una infraestructura de vanguardia que garantice un
            suministro eficiente y confiable, superando las expectativas de los
            clientes y cumpliendo siempre con la normativa vigente.
          </p>
        </div>
        <div>
          <h3 className="font-montserrat font-bold text-3xl md:text-4xl text-[#181818] mb-4">
          ...
          <p className="font-montserrat text-[14px] text-[#444]">
            Grupo Marsori establece su compromiso con el desarrollo de negocios
            nacionales e internacionales en la ingeniería, procura,
            ...
            natural, gas LP y derivados del petróleo, así como la gestión de las
            importaciones de hidrocarburos, con base en el Sistema Integrado de
            Gestión (ISO 9001:2015, ISO 14001:2015 y OHSAS 18001:2007), para
            satisfacer a sus clientes y grupos de interés mediante el
            cumplimiento de los requisitos legales y reglamentarios aplicables
            con el cuidado y protección del medio ambiente, el uso racional de
            los recursos, así como la seguridad y salud de todo el personal, los
            objetivos estratégicos desarrollados al personal de manera integral
            y promoviendo la mejora continua de sus procesos.
          </p>
        </div>
      </div>
    </section>
